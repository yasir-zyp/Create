...
1.在文件编辑器上，使用全局替换的方式，将文件夹下的所有 `116.62.172.222`替换为服务器的ip
...
请自行116.62.172.222替换为服务器ip

 - mysql: 使用数据库连接工具进行连接， 端口3306 账号及密码 root/root
 - minio: http://116.62.172.222:9000 账号及密码 admin/admin123456
 - redis: 端口6379，没有密码
 - nacos: http://116.62.172.222:8848/nacos 账号及密码 nacos/nacos
 - kibana: http://116.62.172.222:5601
 - rocketmq-console：http://116.62.172.222:8180
...
http://116.62.172.222:5601/app/dev_tools#/console
